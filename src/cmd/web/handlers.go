...
import (
	...
	"github.com/akthrms/snippetbox/internal/models"
	"github.com/akthrms/snippetbox/internal/validator"
...
func (app *application) snippetCreatePost(w http.ResponseWriter, r *http.Request) {
	...
	form.CheckField(validator.NonBlank(form.Content), "content", "This field cannot be blank")
